...
class Car extends Factory {
	constructor(model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, warranty, options){
		super(warranty)
		this.model = model
		this.doors = doors
		this.color = color
...
class Truck extends Factory {
	constructor(model, color, enginesize, hitch, trim, bed, navigation, doors, warranty, options){
		super(warranty)
		this.model = model
		this.color = color
		this.trim = trim
...
let custMaz3options = ['weather package', ' satellite radio', ' rear spoiler']

let custMaz3 = new Car('mazda3', 4, 'yellow', 'hybrid', 'automatic', 'Touring', 'base', 'premium', 'leather',  true, custMaz3options)


custMaz3.customerBuild("yellow", custMaz3options)
...
let custMiataRfoptions = ['HID headlights', ' Sports Suspension', ' Leather Steering Wheel', ' Heated Seats', ' Adaptive Cruise Control']
miataRf.customerBuild("black", custMiataRfoptions)
...
custTrailBlazer = ["seat warmers", " tinted windows", " fog lamps"]

trailBlazer.customerBuild("red", custTrailBlazer)
